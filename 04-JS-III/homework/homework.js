...
var guardarNumero = numero
var guardar= []

 // while igual que un for
var nuevo = 0
while (nuevo < 10){  // repetir cod 10 veces 
 nuevo = nuevo + 1 


  // aumentar de en 2 el num recibido
guardarNumero = guardarNumero + 2 
guardar.push (guardarNumero)

if (guardarNumero === nuevo){
